...
/**
 * WenshijiDataId entity. @author MyEclipse Persistence Tools
 */

public class WenshijiDataId implements java.io.Serializable {
	...
	/** default constructor */
	public WenshijiDataId() {
	}

	/** full constructor */
	public WenshijiDataId(String staffId, String equipId, String sampleId,
			Timestamp testtime) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WenshijiDataId))
			return false;
		WenshijiDataId castOther = (WenshijiDataId) other;
