...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">智能实验室平台</a></h1>
</div>
<!--close-Header-part--> 
...
<!--start-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-file"></i>检测</a>
  <ul>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 主页</a> <a href="#" class="current">检测</a><a href="#" class="current">温度测量</a></div>
    <h1>温度测量</h1>
  </div>
  <div class="widget-content">
            
           <center> <div class="btn-group">
              <button data-toggle="dropdown" class="btn dropdown-toggle">选择测量仪器 <span class="caret"></span></button>
              <ul class="dropdown-menu">
             ...
             <div class="btn-group">
              <button data-toggle="dropdown" class="btn dropdown-toggle">选择样品编号 <span class="caret"></span></button>
              <ul class="dropdown-menu">
                <li><a href="#">Action</a></li>
                <li><a href="#">Another action</a></li>
                <li><a href="#">Something else here</a></li>
          ...
          <center><button class="btn btn-success btn-mini">确认结果</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <button class="btn btn-warning btn-mini">重新检测</button></center>
